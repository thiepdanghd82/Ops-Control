...
const SOURCING_DATASET = {
  ...
  aliases: aliasMap({
    ...
    moq: ['MOQ', 'Supplier MOQ', 'Min Order'],
    lt: ['LT', 'Lead Time', 'Leadtime'],
    supplier: ['Supplier', 'Vendor', 'NCC'],
