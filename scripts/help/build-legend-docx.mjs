...
const formula = (name, expr, note, example) => {
  ...
  if (note) {
    out.push(
      new Paragraph({
        children: [
          new TextRun({ text: note, font: FONT, size: 20, italics: true, color: '6B7280' }),
        ],
...
const titlePage = [
  new Paragraph({
    children: [
      new TextRun({
        text: 'Pricing Worksheet (Standard)',
        font: FONT,
        size: 44,
        bold: true,
        color: COLOR_ACCENT,
  ...
  new Paragraph({
    children: [
      new TextRun({ text: 'Legend — Formula Reference', font: FONT, size: 36, bold: true }),
    ],
    spacing: { after: 120 },
    alignment: AlignmentType.CENTER,
  }),
  new Paragraph({
    children: [
      new TextRun({
        text: 'Bảng tính giá (Tiêu chuẩn) — Tham chiếu công thức',
        font: FONT,
        size: 24,
        italics: true,
        color: '6B7280',
  ...
  new Paragraph({
    children: [
      new TextRun({ text: 'Source of truth: services/calcEngine.js', font: MONO, size: 20 }),
    ],
    spacing: { after: 40 },
    alignment: AlignmentType.CENTER,
  }),
  ...
  new Paragraph({
    children: [
      new TextRun({ text: 'CCL Design Vietnam — Ops Control', font: FONT, size: 22, bold: true }),
    ],
    spacing: { after: 80 },
    alignment: AlignmentType.CENTER,
  }),
...
const section00 = [
  ...
  ...callout(
    '✅',
    'Audit provenance · Xuất xứ kiểm chứng',
    ...
    [
      ...
      new TableRow({
        children: [
          ...
          cellText('1 − (s_mat_cost + tooling + packing_ship) / sp_price', {
            width: 5000,
            mono: true,
          }),
      ...
      new TableRow({
        children: [
          ...
          cellText('1 − (s_mat_cost + tooling + packing_ship + run_labor_only) / sp_price', {
            width: 5000,
            mono: true,
          }),
    ...
    [
      ...
      ...[
        [
          ...
          '✅',
          'T3000001',
          'Internal CCL product code. Format: T + 7 digits',
          'Quote ID',
        ],
        ...
        [
          ...
          '✅',
          '3,000,000',
          'Estimated Annual Usage. Used for tooling EAU cap',
        ...
        [
          ...
          '⬜',
          '3',
          'Years. EAU_total = Annual × Lifetime',
          'Tooling lifetime cap',
        ],
        [
          'Trade Mode',
          '✅',
          'USD(Normal)',
          'USD(Normal): no VAT · USD(Book): +15% · VND/RMB: local',
          'VAT Loss',
        ],
        ...
        [
          ...
          '✅',
          '0.099',
          'Target selling price (USD). SP=0 → VA% / GM% = N/A',
          'VA%, CONTR%, GM%',
        ],
        [
          'Target CONTR%',
          '⬜',
          '25',
          'Target Contribution % for reverse Target SP',
          'Target Price',
        ],
    ...
    [
      ...
      ...[
        [
          ...
          'part_width',
          '82',
          'Width in the TD direction (across web)',
          'QPA(m²)',
        ],
        [
          'Part Length (mm)',
          'sheet_length',
          '52',
          'Length in MD direction — used to calculate Pitch',
          'Pitch, QPA',
        ],
        ...
        [
          ...
          'num_webs',
          '1',
          'Parallel web lanes. = 2 for duplex web',
          'QPA_LM, UPH',
        ],
        ...
        [
          ...
          'pcs_per_roll',
          '50,000',
          'Pieces per roll — Meter/Roll display only',
          'Display only',
        ],
      ].map(
        ([f, v, ex, d, a]) =>
...
const section04 = [
  ...
  p('Setup + Run, Offcut %, Scrap factor, VAT Loss — calcMat()', {
    italics: true,
    color: '6B7280',
  }),
  ...
  ...callout(
    '⚠',
    'Corrected — Offcut priority order',
...
Priority 3 (legacy log_width fallback):
  ...
  ...formula(
    'Ink Run Cost — SS / Flexo / LP (non-Indigo)',
...
Ink_Setup  = price × (setup_kg + coverage>0
  ...
  ...formula(
    'Ink Run Cost — Indigo (click-based)',
...
const section05 = [
  ...
  ...callout(
    'ℹ',
    'How the engine resolves speed_uom',
...
Pitch is floored at 1 via max(1, pitch) to avoid div-by-zero.`,
  ...
  ...formula(
    'UPH (m/min)',
    'uph = speed × eff × 60 × 1000 / max(1, pitch) × layout',
    '✅ Verified — pitch in mm, ×1000 converts m→mm.'
  ),
  ...formula(
    'UPH (Mtr/Hr)',
    'uph = speed × eff × 1000 / max(1, pitch) × layout',
    '✅ Verified — matches "mtr/hr" OR "m/hr".'
  ),
  ...formula(
    'UPH (Stamp/min)',
    'uph = speed × eff × 60 × layout',
    '✅ Verified — 1 stroke = Layout cavities.'
  ),
  ...formula(
    'UPH (Pcs/hr)',
    'uph = speed × eff',
    '✅ Verified — direct pcs/hr, no Layout multiplier.'
  ),
  ...formula(
    'UPH (Sheets/hr)',
    'uph = speed × eff × layout',
    '✅ Verified — accepts "sheets/hr" and "sheet/hr".'
  ),
...
tool = totalToolPcs > eau
  ...
  ...formula(
    'Tooling/unit — Jig (normalized match)',
...
const section06 = [
  ...
  ...formula(
    'Shipping/unit',
    '(shipping_cost + other_ship) / ship_qty',
  ...
  ...callout(
    '⚠',
    'Sprint 21 Finance alignment — xlsx is stale',
...
this is the Finance-signed-off correction.`,
  ...
  ...callout(
    '⚠',
    'Critical interpretation difference vs. xlsx',
    ...
    [
      ...
      ...[
        [
          'SS (Screen)',
          '30 m²/kg',
          'price × QPA × area% × w_m / 30 / (1−S)',
          'Heavy ink — highest consumption',
        ],
        ...
        [
          'Indigo Spot',
          '176',
          'price × QPA × area% × w_m / 176 / (1−S)',
          'Spot color — higher consumption',
        ],
...
const section10 = [
  ...
  ...[
    {
      sev: 'CRITICAL',
      title: '#1 — VA% / GM% = −435,000% (extremely large negative)',
    ...
    {
      sev: 'CRITICAL',
      title: '#2 — G.TOTAL ×250,000 too high (MOQ not entered)',
    ...
    {
      sev: 'CRITICAL',
      title: '#3 — Tooling cost unreasonably high (> 5% of total)',
    ...
    {
      sev: 'MEDIUM',
      title: '#4 — Material cost = $0 (even after selecting material)',
    ...
    {
      sev: 'MEDIUM',
      title: '#5 — UPH = 0 → Machine / Labor cost = $0',
    ...
    {
      sev: 'MEDIUM',
      title: '#6 — Unexpected VAT Loss appears',
    ...
    {
      sev: 'MINOR',
      title: '#8 — Ink cost = $0 (after entering ink color)',
    ...
    {
      sev: 'MINOR',
      title: '#9 — Quote saved but not visible in History',
    ...
    {
      sev: 'INFO',
      title: '#10 — GM% different when reloading quote from History',
  ...
  new Paragraph({
    children: [
      new TextRun({
        text: '— End of Formula Reference · Hết tài liệu tham chiếu —',
        font: FONT,
        size: 22,
        italics: true,
        color: '9CA3AF',
...
const footer = new Footer({
  children: [
    new Paragraph({
      children: [
        new TextRun({
          text: 'Ops Control · Pricing Worksheet Legend · CCL Design Vietnam',
          font: FONT,
          size: 16,
          color: '6B7280',
        }),
...
const doc = new Document({
  ...
  description:
    'Formula reference for the Standard Pricing Worksheet. Verified against calcEngine.js.',
  styles: {
