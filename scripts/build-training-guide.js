  ...
  return [
    // ── 00 Contents ─────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        {
          type: 'table',
          header: [t('No.', 'STT'), t('Sheet', 'Trang'), t('Description', 'Mô tả')],
          rows: [
            [
              1,
              t('01_Getting Started', '01_Bắt đầu'),
              t(
                'Login, sidebar navigation, modules, breadcrumbs, user roles',
                'Đăng nhập, điều hướng sidebar, module, breadcrumb, vai trò người dùng'
              ),
            ],
            [
              2,
              t('02_Standard Calculator', '02_Standard Calc'),
              t(
                'Single-product pricing: Header, Layout, Materials, Inks, Processes, Packing',
                'Báo giá 1 sản phẩm: Header, Layout, Vật tư, Mực in, Công đoạn, Đóng gói'
              ),
            ],
            [
              3,
              t('03_Complex Calculator', '03_Complex Calc'),
              t(
                'Multi sub-product assemblies with cross-references and tiered pricing',
                'Sản phẩm lắp ráp nhiều sub-product có tham chiếu chéo và bậc giá'
              ),
            ],
            [
              4,
              t('04_Cost Breakdown', '04_Cost Breakdown'),
              t(
                'Summarize tab: all saved quotes expanded per MOQ tier, search, CSV export',
                'Tab Summarize: toàn bộ báo giá theo bậc MOQ, tìm kiếm, xuất CSV'
              ),
            ],
            [
              5,
              t('05_Quote Workflow', '05_Quy trình báo giá'),
              t(
                'End-to-end: RFQ Tracker → Calculator → Formal Quotation → Quote History',
                'Quy trình trọn vẹn: RFQ Tracker → Máy tính → Báo giá chính thức → Lịch sử báo giá'
              ),
            ],
            [
              6,
              t('06_Libraries', '06_Thư viện'),
              t(
                'Rate Table, Drop-Down Lists, Finance Data, Material Library — per site',
                'Bảng Rate, Drop-Down, Finance Data, Thư viện vật tư — theo site'
              ),
            ],
            [
              7,
              t('07_Import / Export', '07_Import / Export'),
              t(
                'CSV/XLSX upload for IFS Inventory, Routing, Rate Table, NPI Materials',
                'Upload CSV/XLSX cho IFS Inventory, Routing, Rate Table, NPI Materials'
              ),
            ],
            [
              8,
              t('08_Backup & Restore', '08_Sao lưu & Khôi phục'),
              t(
                'Data backups (JSON) and Code backups (full source snapshots) with restore',
                'Sao lưu Data (JSON) và Code (snapshot toàn bộ source) kèm khôi phục'
              ),
            ],
            [
              9,
              t('09_Settings', '09_Cài đặt'),
              t(
                'Account Control: roles, session token TTL, password reset, 2FA',
                'Account Control: phân quyền, session TTL, reset mật khẩu, 2FA'
              ),
            ],
            [
              10,
              t('10_Master Formulas', '10_Công thức chính'),
              t(
                'All 41 pricing formulas (Layout, Materials, Processes, Summary)',
                'Toàn bộ 41 công thức giá (Layout, Vật tư, Công đoạn, Tổng hợp)'
              ),
            ],
            [
              11,
              t('11_Troubleshooting', '11_Xử lý sự cố'),
              t(
                'Common errors, root causes and step-by-step fixes',
      ...
      blocks: [
        {
          ...
          text: t(
            ...
            'BẮT ĐẦU — ĐĂNG NHẬP, ĐIỀU HƯỚNG & VAI TRÒ'
          ),
          span: 3,
        },
        ...
        {
          type: 'table',
          header: [t('Step', 'Bước'), t('Action', 'Thao tác'), t('Notes', 'Ghi chú')],
          rows: [
            [
              1,
              t(
                'Open the app URL in your browser (typically http://<server>:3000)',
                'Mở URL ứng dụng trên trình duyệt (thường là http://<server>:3000)'
              ),
              t(
                'Chrome / Edge / Safari — any modern browser',
                'Chrome / Edge / Safari — trình duyệt hiện đại'
              ),
            ],
            [
              2,
              t(
                'Enter Username + Password on the login card (subtitle: "Server version.")',
                'Nhập Username + Password vào khung login (phụ đề: "Server version.")'
              ),
              t(
                'Credentials are managed by SYS in Settings → Account Control',
            ...
            [
              3,
              t(
                'Check "Remember me" to keep your session longer',
                'Tick "Remember me" để session tồn tại lâu hơn'
              ),
              t(
                'Session duration is set per-user by SYS (Def / 1h / 8h / 24h / 7d)',
        ...
        {
          type: 'section',
          text: t('B. SIDEBAR & MODULE SWITCHING', 'B. SIDEBAR & CHUYỂN MODULE'),
          span: 3,
        },
        {
          type: 'note',
        ...
        {
          type: 'table',
          header: [t('Section', 'Nhóm'), t('Tabs', 'Các tab'), t('Who uses it', 'Ai dùng')],
          rows: [
            [
              'CALCULATORS',
              'Standard · Complex · Material Cost · Inks Calculator',
              t('Cost engineers creating new quotes', 'Nhân viên cost tạo báo giá mới'),
            ],
            [
              'QUOTING & PRICING',
              'Cost Breakdown · Formal Quotation · Quote History',
              t(
                'Anyone viewing or releasing saved quotes',
                'Người xem hoặc phát hành báo giá đã lưu'
              ),
            ],
            [
              'MANUFACTURING',
              'Mfg Structures · Routing Ops · IFS Inventory',
              t(
                'Reference data synced from IFS — mostly read-only',
                'Dữ liệu tham chiếu sync từ IFS — thường chỉ đọc'
              ),
            ],
            [
              'TRACKING',
              'RFQ Tracker · Sample Tracking',
              t(
                'Sales + NPI teams logging customer inquiries',
                'Sales + NPI ghi nhận inquiry khách'
              ),
            ],
            [
              'LIBRARIES',
              'Rate Table (⏱) · Drop-Down Lists (⏷) · Finance Data (⚖)',
              t('Cost engineers maintaining rates and DDLs', 'Cost engineer quản lý rate và DDL'),
            ],
            [
              'SYSTEM',
              'Settings',
        ...
        },
        {
          type: 'section',
          text: t(
            'C. USER ROLES — WHAT EACH ROLE CAN DO',
            'C. VAI TRÒ NGƯỜI DÙNG — QUYỀN TỪNG VAI TRÒ'
          ),
          span: 3,
        },
        {
          type: 'table',
          header: [t('Role', 'Vai trò'), t('Can do', 'Được làm'), t('Cannot do', 'Không được làm')],
          rows: [
            [
              'SYS',
              t(
                'Everything — user CRUD, role changes, code backup/restore, system logs',
            ...
            [
              'ADMIN',
              t(
                'User edits (not delete), Rate/DDL/Finance edit, Data backup/restore',
                'Sửa user (không xoá), sửa Rate/DDL/Finance, Data backup/restore'
              ),
              t(
                'Delete users, code restore, role changes above own level',
            ...
            [
              'COST',
              t(
                'Full pricing tabs, save/update quotes, import Rate/DDL/Material',
                'Toàn bộ tab pricing, save/update báo giá, import Rate/DDL/Material'
              ),
              t('User management, system backups', 'Quản lý user, backup hệ thống'),
            ],
            [
              'USER',
              t('Create quotes, view libraries, export CSV', 'Tạo báo giá, xem thư viện, xuất CSV'),
              t('Edit rate/DDL, delete anything', 'Sửa rate/DDL, xoá dữ liệu'),
            ],
            [
              'VIEW',
      ...
      blocks: [
        {
          type: 'title',
          text: t(
            'STANDARD CALCULATOR — SINGLE-PRODUCT PRICING',
            'MÁY TÍNH STANDARD — BÁO GIÁ 1 SẢN PHẨM'
          ),
          span: 4,
        },
        {
        ...
        {
          type: 'section',
          text: t('A. HEADER TAB — BASIC INFO', 'A. TAB HEADER — THÔNG TIN CHUNG'),
          span: 4,
        },
        {
          type: 'table',
          ...
          rows: [
            [
              ...
              'T3000001',
              t(
                'Internal CCL code (T + 7 digits) — anchors the quote in history',
            ...
            [
              ...
              'RFQ-26-0042',
              t(
                'Customer RFQ reference — auto-linked to RFQ Tracker when saved',
            ...
            [
              ...
              '⬜',
              'Samsung VN',
              t('Shows on Formal Quotation document', 'Xuất hiện trên Formal Quotation'),
            ],
            [
              'MOQ',
              '✅',
              '250,000',
              t(
                '⚠ MUST be > 0. MOQ = 0 causes Setup/Tooling divided by 1 → G.TOTAL inflated',
            ...
            [
              ...
              '3,000,000',
              t(
                'Annual volume — used for tooling amortization',
            ...
            [
              ...
              'USD(Normal)',
              t(
                'USD(Normal) = export, no VAT loss. USD(Book) = domestic, 8–10% VAT loss',
            ...
            [
              ...
              'VN',
              t(
                'Selects which workcenter rate table applies (VN / 41 RDC / 55 site / ...)',
            ...
            [
              ...
              '0.099',
              t(
                'Required for GM% / VA% / Contr%. Warning shows in bottom WarningBar if 0',
        ...
        {
          type: 'section',
          text: t('B. LAYOUT TAB — GEOMETRY', 'B. TAB LAYOUT — HÌNH HỌC'),
          span: 4,
        },
        {
          type: 'table',
          ...
          rows: [
            ...
            [
              'Part Length (MD)',
              '52 mm',
              t('Pitch, QPA', 'Pitch, QPA'),
              t('Along-machine dimension', 'Kích thước theo chiều chạy máy'),
            ],
            ['Num Webs', '1', 'QPA_LM, UPH', t('2 for duplex web', '2 cho duplex web')],
            [
              'Parts in MD / TD',
              '1 / 4',
              t('Layout per sheet', 'Layout/sheet'),
            ...
            [
              ...
              t('Pitch', 'Pitch'),
              t(
                '0 = sheet mode; ≥1 = rotary mode (Pitch based on 3.175 mm pitch)',
            ...
            [
              ...
              'Offcut %',
              t(
                'Parent log width — offcut = log_w mod mat_w',
        ...
        {
          type: 'section',
          text: t('D. PROCESSES TAB — MACHINE & LABOR', 'D. TAB PROCESSES — MÁY & NHÂN CÔNG'),
          span: 4,
        },
        {
          type: 'table',
          ...
          rows: [
            ...
            [
              ...
              'Rate, UPH',
              t(
                'Machine code — Rate looked up from Rate Table for the active Site',
            ...
            [
              ...
              '60',
              'UPH',
              t('UOM auto-filled (m/min, stamps/min, ...)', 'UOM tự điền (m/min, stamps/min, ...)'),
            ],
            ['Efficiency', '0.85', 'UPH', t('0–1. Default 85%', '0–1. Mặc định 85%')],
            [
              'Setup Hours',
              '2',
              'Setup cost',
            ...
            [
              ...
              'Yield, UPH',
              t(
                'Process yield loss. Yield% = 1 − Σ(scrap_pct)',
            ...
            [
              ...
              'Tooling cost',
              t(
                '⚠ DO NOT leave blank — tool_life fallback = 1 → huge tooling cost',
      ...
      blocks: [
        {
          type: 'title',
          text: t(
            'COMPLEX CALCULATOR — MULTI SUB-PRODUCT ASSEMBLIES',
            'MÁY TÍNH COMPLEX — LẮP RÁP NHIỀU SUB-PRODUCT'
          ),
          span: 3,
        },
        {
        ...
        {
          type: 'table',
          header: [t('SP Code', 'Mã SP'), t('Role', 'Vai trò'), t('Example', 'Ví dụ')],
          rows: [
            [
              'FG Z',
              t('Finished good — what ships to the customer', 'Thành phẩm — sản phẩm giao khách'),
              'FG-Label-Assy',
            ],
            [
              'SP 0..n',
              t(
                'Sub-products referenced by FG Z (face, liner, adhesive layer, ...)',
                'Sub-product FG Z tham chiếu (face, liner, lớp keo...)'
              ),
              'SP-Face, SP-Adhesive',
            ],
          ],
        ...
        {
          type: 'section',
          text: t('B. TIERED PRICING (num_moq)', 'B. BÁO GIÁ THEO BẬC (num_moq)'),
          span: 3,
        },
        {
          type: 'note',
        ...
        {
          type: 'section',
          text: t('C. CROSS-REFERENCE CHECK', 'C. KIỂM TRA THAM CHIẾU CHÉO'),
          span: 3,
        },
        {
          type: 'table',
          header: ['#', t('Check', 'Kiểm tra'), t('Why', 'Lý do')],
          rows: [
            [
              1,
              t(
                'Every material code referencing another SP must exist in this quote',
                'Mọi mã vật tư tham chiếu SP khác phải tồn tại trong báo giá này'
              ),
              t(
                'Otherwise the engine silently skips the reference → cost too low',
            ...
            [
              2,
              t(
                'FG Z row must be the LAST row so it sees all upstream SP results',
            ...
            [
              3,
              t(
                'ship_qty on each SP = expected yield qty, not input qty',
    ...
    // ── 04 Cost Breakdown ───────────────────────────────────
    {
      ...
      blocks: [
        {
          type: 'title',
          text: t('COST BREAKDOWN — SUMMARIZE TAB', 'COST BREAKDOWN — TAB SUMMARIZE'),
          span: 3,
        },
        {
          type: 'note',
        ...
        {
          type: 'table',
          header: [t('Column', 'Cột'), t('Formula', 'Công thức'), t('Notes', 'Ghi chú')],
          rows: [
            [
              'RFQ NO',
              t('state.rfq_number OR Q<id>', 'state.rfq_number HOẶC Q<id>'),
              t(
                'Right-click → color bar to tag important rows',
            ...
            [
              ...
              'state.project',
              t(
                'Legacy naming — field is "project" in state',
            ...
            [
              ...
              '1 − Σ(scrap_pct)',
              t(
                'Simple sum across every process with a workcenter',
            ...
            [
              ...
              'r.s_mat_cost',
              t(
                'Total material $/unit including Setup LM, Offcut%, VAT loss',
            ...
            [
              ...
              '(SP − G.Total) / SP',
              t(
                'Color-coded: green ≥20%, amber ≥10%, red <10%',
        ...
        {
          type: 'table',
          header: [t('Feature', 'Tính năng'), t('How', 'Cách dùng'), t('Notes', 'Ghi chú')],
          rows: [
            [
              t('Search', 'Tìm kiếm'),
              t('Top-right search box', 'Ô search phải trên'),
              t(
                'Filters by CCL PN, customer, project, RFQ, NPI owner, End CU PN',
            ...
            [
              ...
              t(
                'Open (load in calc), Color bar, Copy row',
            ...
            [
              ...
              t(
                'All visible columns, all filtered rows',
    ...
    // ── 05 Quote Workflow ───────────────────────────────────
    {
      ...
      blocks: [
        {
          type: 'title',
          text: t('END-TO-END QUOTE WORKFLOW', 'QUY TRÌNH BÁO GIÁ TRỌN VẸN'),
          span: 4,
        },
        ...
        {
          type: 'table',
          header: ['#', t('Stage', 'Giai đoạn'), t('Tab', 'Tab'), t('Output', 'Kết quả')],
          rows: [
            [
              1,
              t('Log inquiry', 'Ghi nhận inquiry'),
              'RFQ Tracker',
              t(
                'RFQ row with customer, project, owner, deadline',
                'Dòng RFQ gồm khách, project, owner, deadline'
              ),
            ],
            [
              2,
              t('Build quote', 'Xây báo giá'),
              'Standard / Complex Calculator',
              t(
                'quote_history.json entry via Save/Update',
                'Entry trong quote_history.json qua Save/Update'
              ),
            ],
            [
              3,
              t('Review cost rollup', 'Review cost tổng'),
              'Cost Breakdown',
              t(
                'Verify GM% is green (≥20%) across all MOQ tiers',
                'Kiểm tra GM% xanh (≥20%) ở mọi bậc MOQ'
              ),
            ],
            [
              4,
              t('Issue document', 'Phát hành tài liệu'),
              'Formal Quotation',
              t(
                'Library/ReleasedQuotation/<ref>_<ts>.json via /save-quotation',
                'Library/ReleasedQuotation/<ref>_<ts>.json qua /save-quotation'
              ),
            ],
            [
              5,
              t('Audit history', 'Kiểm tra lịch sử'),
              'Quote History',
              t('Right-click → Open to reload any revision', 'Click phải → Open để mở lại bản cũ'),
            ],
          ],
        },
        ...
        {
          type: 'table',
          header: ['#', t('Practice', 'Nguyên tắc'), t('Why', 'Lý do'), t('Notes', 'Ghi chú')],
          rows: [
            [
              1,
              t(
                'Always enter RFQ Number in Header before Save',
                'Luôn nhập RFQ Number ở Header trước khi Save'
              ),
              t(
                'Links Cost Breakdown / Quote History back to the tracker',
            ...
            [
              2,
              t(
                'Use "Update" (not "Save New") when refining a live quote',
                'Dùng "Update" (không "Save New") khi chỉnh báo giá đang mở'
              ),
              t(
                'Keeps a single version; Save New creates a new id',
            ...
            [
              3,
              t(
                'Release only AFTER Cost Breakdown GM% is green for every tier',
                'Chỉ Release SAU KHI mọi bậc Cost Breakdown có GM% xanh'
              ),
              t('Released quotations are hard to recall', 'Báo giá đã phát hành khó thu hồi'),
              t('Green = ≥20% GM', 'Xanh = GM ≥20%'),
            ],
            [
              4,
              t(
                'Watch the WarningBar at the bottom — fix all errors before Save',
                'Theo dõi WarningBar dưới cùng — sửa hết lỗi trước khi Save'
              ),
              t(
                'New in v1.0 — live validation of every required field',
      ...
      blocks: [
        {
          type: 'title',
          text: t(
            'LIBRARIES — RATE TABLE, DDL, FINANCE DATA',
            'THƯ VIỆN — RATE TABLE, DDL, FINANCE DATA'
          ),
          span: 2,
        },
        ...
        {
          type: 'table',
          header: [t('Action', 'Thao tác'), t('How', 'Cách dùng')],
          rows: [
            [
              t('Edit a rate', 'Sửa rate'),
              t(
                'Click the cell, type the new value, then Save (Save enables only when dirty)',
            ...
            [
              ...
              t(
                'Click "+ Add Row" below the table (moved from toolbar in v1.0)',
            ...
            [
              ...
              t(
                'Click Import → pick a file. Columns are fuzzy-matched. Blank rows filtered automatically.',
            ...
            [
              ...
              t(
                'Backup writes to Library/Rate/backups/. Restore lists all backups.',
            ...
            [
              ...
              t(
                'Server writes Library/Rate/rate_<site>.csv and streams to the browser',
        ...
        {
          type: 'table',
          header: [t('Key Table', 'Bảng quan trọng'), t('Purpose', 'Công dụng')],
          rows: [
            [
              'tool_life',
              t(
                'Shots before tool replacement — feeds Tooling formula in calcAll()',
            ...
            [
              'click_charge',
              t(
                'Indigo cost per click — used when print_type = Indigo',
                'Cost/click Indigo — dùng khi print_type = Indigo'
              ),
            ],
            [
              'ink_coverage',
              t('SS/Flexo/LP coverage % by print type', 'Coverage % SS/Flexo/LP theo print type'),
            ],
          ],
        },
    ...
    // ── 07 Import / Export ──────────────────────────────────
    {
      ...
      blocks: [
        {
          type: 'title',
          text: t('IMPORT / EXPORT — CSV & XLSX', 'IMPORT / EXPORT — CSV & XLSX'),
          span: 3,
        },
        ...
        { type: 'section', text: t('A. WHAT YOU CAN IMPORT', 'A. CÓ THỂ IMPORT GÌ'), span: 3 },
        {
          ...
          header: [
            t('Dataset', 'Dữ liệu'),
            t('Endpoint', 'Endpoint'),
            t('Required headers (any-case)', 'Header bắt buộc'),
          ],
          rows: [
        ...
        {
          type: 'table',
          header: [t('Step', 'Bước'), t('What happens', 'Diễn biến'), t('Notes', 'Ghi chú')],
          rows: [
            [
              1,
              t(
                'Server receives the file via multipart upload (max 50 MB)',
            ...
            [
              2,
              t(
                'Parses CSV (comma/semicolon/tab) or XLSX (xlsx package)',
            ...
            [
              3,
              t(
                'Validates required headers — refuses file if any are missing',
                'Validate header bắt buộc — từ chối nếu thiếu'
              ),
              t('Prevents wrong-dataset upload', 'Chống upload nhầm dataset'),
            ],
            [
              4,
              t(
                'Backs up the current target file with _backup_<timestamp> suffix',
            ...
            [
              5,
              t(
                'Fuzzy-maps columns (Rate, NPI, Sourcing only)',
                'Fuzzy match cột (chỉ Rate, NPI, Sourcing)'
              ),
              t('Header names are case-insensitive', 'Tên header không phân biệt hoa/thường'),
            ],
            [
              6,
              t('Writes new data, clears server cache', 'Ghi dữ liệu mới, clear cache server'),
              t('Next read serves the new data', 'Lần đọc sau trả dữ liệu mới'),
            ],
          ],
        },
        ...
        {
          type: 'table',
          header: [t('Location', 'Vị trí'), t('Button', 'Nút'), t('Format', 'Định dạng')],
          rows: [
            [
              t('Rate Table', 'Rate Table'),
              'Export CSV',
              t('CSV in Library/Rate/', 'CSV trong Library/Rate/'),
            ],
            [
              t('DDL (per site)', 'DDL (theo site)'),
              'Export CSV',
            ...
            [
              ...
              'CSV Export',
              t('Browser download — all filtered rows', 'Tải về trình duyệt — tất cả dòng đã lọc'),
            ],
            [
              t('Material Library', 'Thư viện vật tư'),
              'Export CSV',
              t(
                'Browser download — current dataset (NPI or Sourcing)',
    ...
    // ── 08 Backup Restore ───────────────────────────────────
    {
      ...
      blocks: [
        {
          type: 'title',
          text: t('BACKUP & RESTORE — DATA AND CODE', 'SAO LƯU & KHÔI PHỤC — DỮ LIỆU VÀ MÃ NGUỒN'),
          span: 2,
        },
        {
          type: 'note',
        ...
        {
          type: 'table',
          header: [t('Action', 'Thao tác'), t('Result', 'Kết quả')],
          rows: [
            [
              t('Create Data Backup', 'Tạo Data Backup'),
              t(
                'Builds a JSON snapshot of 13 library files into Backup & restore/Data/manual_<ts>.json',
            ...
            [
              ...
              t(
                'SYS only. Overwrites library files. A safety pre_restore_<ts>.json is written first.',
            ...
            [
              t('Delete', 'Xoá'),
              t(
                'SYS only. Removes the backup file from disk.',
            ...
            [
              t('Download', 'Tải về'),
              t(
                'Streams the JSON file to the browser — useful for off-site archive',
        ...
        { type: 'section', text: t('B. CODE BACKUP', 'B. CODE BACKUP'), span: 2 },
        {
          ...
          rows: [
            [
              ...
              t(
                'ADMIN+. Copies the entire package source tree into Backup & restore/Code/code_<ts>/. Excludes node_modules, dist, .git, server/data, and the backup folder itself.',
            ...
            [
              ...
              t(
                'SYS only. DANGEROUS — overwrites the running package source. A pre_restore_<ts>/ safety snapshot is created first. You MUST restart the Node server after a code restore.',
        ...
        {
          type: 'section',
          text: t('C. FILES INCLUDED IN A CODE BACKUP', 'C. FILE TRONG CODE BACKUP'),
          span: 2,
        },
        {
          type: 'table',
          header: [t('Included', 'Có'), t('Excluded', 'Không')],
          rows: [
            [
              'client/src, client/index.html, client/package.json',
              'client/node_modules, client/dist',
            ],
            [
              'server/ (routes, services, middleware, legacy)',
              'server/data/** (backed up separately)',
            ],
    ...
    // ── 09 Settings ─────────────────────────────────────────
    {
      ...
      blocks: [
        {
          type: 'title',
          text: t('SETTINGS — ACCOUNT CONTROL & SYSTEM', 'CÀI ĐẶT — ACCOUNT CONTROL & HỆ THỐNG'),
          span: 3,
        },

        {
          type: 'section',
          text: t('A. ACCOUNT CONTROL (SYS / ADMIN)', 'A. ACCOUNT CONTROL (SYS / ADMIN)'),
          span: 3,
        },
        {
          type: 'note',
        ...
        {
          type: 'table',
          header: [t('Action icon', 'Icon'), t('Meaning', 'Ý nghĩa'), t('Role', 'Vai trò')],
          rows: [
            [
              t('Pencil', 'Bút chì'),
              t(
                'Edit profile (full name, email, phone, role)',
            ...
            [
              t('Key', 'Chìa khoá'),
              t(
                'Reset password — prompts for a new plaintext password',
            ...
            [t('Trash', 'Thùng rác'), t('Permanently delete user', 'Xoá user vĩnh viễn'), 'SYS'],
          ],
        },
    ...
    // ── 10 Master Formulas ──────────────────────────────────
    {
      ...
      blocks: [
        {
          type: 'title',
          text: t('MASTER FORMULA REFERENCE — 41 FORMULAS', 'CÔNG THỨC TOÀN BỘ — 41 CÔNG THỨC'),
          span: 5,
        },
        {
          type: 'note',
...

        {
          ...
          rows: [
            ...
            [
              'MAT',
              'Run LM Cost',
              'QPA(m²) × price × (1+offcut) × (1+vat_loss)',
              '$/pc',
              'calcMat()',
            ],
            ...
            [
              'PROC',
              'Tooling/unit',
              '(tool_cost × tool_qty) / min(tool_life × moq, eau)',
              '$/pc',
              'calcProc()',
            ],
            [
            ...
            [
              'SUM',
              'G.Total',
              'mat + oh + lab + tool + pack + ink + vat_loss',
              '$/pc',
              'calcAll()',
            ],
      ...
      blocks: [
        {
          ...
          text: t(
            ...
            'XỬ LÝ SỰ CỐ — LỖI THƯỜNG GẶP & KHẮC PHỤC'
          ),
          span: 5,
        },

        {
          ...
          header: [
            '#',
            t('Symptom', 'Triệu chứng'),
            t('Root cause', 'Nguyên nhân gốc'),
            t('Fix', 'Khắc phục'),
            t('Sev', 'Mức'),
          ],
          rows: [
            [
              ...
              t(
                'Backend running old api.js (POST /save-all with formalQuotation key)',
                'Backend chạy bản api.js cũ (POST /save-all với key formalQuotation)'
              ),
              t(
                'Restart the Node server. Fixed in v1.0 — saveQuotation now calls /save-quotation directly.',
            ...
            [
              ...
              t(
                'ESM __dirname polyfill missing in costApi.js',
                'Thiếu polyfill __dirname trong costApi.js'
              ),
              t(
                'Fixed in v1.0. Any new server file must use fileURLToPath(import.meta.url)',
            ...
            [
              3,
              t('VA% / GM% = −435,000% (extreme negative)', 'VA% / GM% = −435,000% (âm cực lớn)'),
              t('DDL tool_life = 1 instead of 200,000', 'DDL tool_life = 1 thay vì 200,000'),
              t(
                'Open Drop-Down Lists → tool_life → restore correct values',
            ...
            [
              4,
              t('G.Total cost 250,000× too high', 'G.Total cost cao 250,000 lần'),
              t('MOQ = 0 → Setup/Tooling divided by 1', 'MOQ = 0 → Setup/Tooling chia cho 1'),
              t(
                'Always enter MOQ > 0 in Header. Template default = 250,000',
            ...
            [
              5,
              t('Tooling cost > 5% of total', 'Tooling cost > 5% tổng'),
              t(
                'Tool Type not selected → tool_life fallback = 1',
                'Tool Type chưa chọn → fallback tool_life = 1'
              ),
              t(
                'Select Tool Type from dropdown. Verify tool life > 1,000',
            ...
            [
              6,
              t(
                'Material cost = $0 after selecting material code',
                'Material cost = $0 sau khi chọn mã vật tư'
              ),
              t(
                'Width = 0 or Price = 0 in DB; Pitch = 0',
                'Width = 0 hoặc Price = 0 trong DB; Pitch = 0'
              ),
              t(
                'Verify Width > 0 in DB; check Pitch + QPA display',
            ...
            [
              7,
              t(
                'Import CSV fails with "Missing required columns"',
                'Import CSV "Missing required columns"'
              ),
              t(
                'Wrong file for wrong tab — server validates headers',
                'Nhầm file cho tab — server validate header'
              ),
              t(
                'Check 07_Import Export for the required headers',
            ...
            [
              ...
              t('Header names too unusual for fuzzy match', 'Tên cột quá khác so với fuzzy match'),
              t(
                'Use Workcenter / Crew / Machine USD/H / Labor USD/H / Speed UOM / OH Cost',
            ...
            [
              9,
              t('Login OK but sidebar is empty', 'Đăng nhập OK nhưng sidebar trống'),
              t('User role has no module access', 'Role user không có quyền module'),
              t(
                'SYS must grant Ops Cost / Planning module access',
            ...
            [
              10,
              t('"No backups found" even after creating one', '"No backups found" dù đã tạo'),
              t(
                'Wrong tab (Data vs Code) OR folder not writable',
                'Nhầm tab (Data vs Code) HOẶC thư mục không ghi được'
              ),
              t(
                'Switch to the correct tab; check server file permissions',
            ...
            [
              11,
              t('WarningBar at the bottom shows errors', 'WarningBar dưới cùng hiện lỗi'),
              t(
                'Required calc fields missing or 0 — see the message',
                'Field bắt buộc còn thiếu hoặc = 0 — xem message'
              ),
              t(
                'Click the bar to expand all errors, fix them one by one',
...
function renderBlock(ws, block, ncols, rowPointer) {
  ...
  if (block.type === 'title') {
    ...
    ws.mergeCells(
      r,
      1,
      r + (block.height && block.height > 40 ? 1 : 0),
      Math.min(block.span || ncols, ncols)
    );
