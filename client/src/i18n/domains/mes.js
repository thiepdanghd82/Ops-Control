...
registerStrings({
  ...
  // Label printer card
  'hw.lp.title': {
    en: '🖨 Label Printer (Zebra / TSC) — TCP:9100',
    vi: '🖨 Máy in nhãn (Zebra / TSC) — TCP:9100',
  },
  ...
  'hw.lp.test_sent': {
    en: 'Test label sent — check the printer.',
    vi: 'Đã gửi nhãn test — kiểm tra máy in.',
  },
  'hw.lp.test_err': { en: 'Send-label error: {msg}', vi: 'Lỗi gửi nhãn: {msg}' },
  'hw.lp.ok_latency': {
    en: '✓ Connection OK — latency {ms} ms',
    vi: '✓ Kết nối OK — latency {ms} ms',
  },
  'hw.lp.err': { en: '✗ Error: {err}', vi: '✗ Lỗi: {err}' },

  // Scale card
  'hw.sc.title': {
    en: '⚖️ Electronic Scale — RS232 / USB-Serial',
    vi: '⚖️ Cân điện tử — RS232 / USB-Serial',
  },
  ...
  // Scanner card
  'hw.sn.title': {
    en: '📷 Barcode Scanner — USB-HID / Keyboard Wedge',
    vi: '📷 Máy quét barcode — USB-HID / Keyboard Wedge',
  },
  'hw.sn.wedge_label': {
  ...
  'mode.embedded.subtitle': {
    en: 'In-process server · Single-user',
    vi: 'Server in-process · Single-user',
  },
  'mode.embedded.desc': {
  ...
  'mode.thin.subtitle': {
    en: 'Remote server · Multi-user (recommended)',
    vi: 'Remote server · Multi-user (khuyên dùng)',
  },
  'mode.thin.desc': {
  ...
  'mode.smart.con1': {
    en: 'Conflict resolution: last-write-wins',
    vi: 'Conflict resolution: last-write-wins',
  },
  'mode.smart.con2': {
    en: 'Per-endpoint cache wiring is incremental',
    vi: 'Per-endpoint cache wiring incremental',
  },
  ...
  // Phase A.3a — Test Connection button next to the URL input
  'mode.test.button': { en: 'Test Connection', vi: 'Kiểm tra kết nối' },
  'mode.test.testing': { en: 'Testing…', vi: 'Đang kiểm tra…' },
  'mode.test.success': {
    en: '✓ Connected (v{version}, {ms}ms)',
    vi: '✓ Đã kết nối (v{version}, {ms}ms)',
  },
  'mode.test.fail': { en: '✗ Connection failed: {error}', vi: '✗ Kết nối thất bại: {error}' },
  // Phase A.3a — Import .opsconn profile button
  'mode.opsconn.import_button': { en: 'Import .opsconn profile', vi: 'Nhập file .opsconn' },
  'mode.opsconn.import_hint': {
    en: 'Connection profile from your admin — auto-fills the URL and switches to Thin mode.',
    vi: 'File hồ sơ kết nối từ admin — tự điền URL và chuyển sang chế độ Thin.',
  },
  'mode.opsconn.imported': {
    en: 'Profile "{name}" imported — review and click Apply.',
    vi: 'Đã nhập hồ sơ "{name}" — kiểm tra rồi nhấn Áp dụng.',
  },
  // Phase A.3a — D4 confirmation modal (only fires when current mode is embedded)
  'mode.opsconn.switch_title': { en: 'Switch to thin mode?', vi: 'Chuyển sang chế độ Thin?' },
  'mode.opsconn.switch_message': {
    en: 'Importing "{name}" will switch this app from embedded (local server) to thin (remote server: {url}). Local data is kept but will not sync until you switch back.',
    vi: 'Nhập "{name}" sẽ chuyển app này từ embedded (server local) sang thin (server từ xa: {url}). Dữ liệu local được giữ nguyên nhưng không sync cho đến khi chuyển lại.',
  },
  'mode.opsconn.switch_confirm': { en: 'Switch to thin mode', vi: 'Chuyển sang Thin' },
  'mode.opsconn.switch_cancel': { en: 'Cancel', vi: 'Huỷ' },
  'mode.opsconn.cancelled': {
    en: 'Import cancelled — mode unchanged.',
    vi: 'Đã huỷ nhập — chế độ không đổi.',
  },
  ...
  'mode.saved_restart': {
    en: '✅ Config saved. Restart the app to apply the new mode.',
    vi: '✅ Đã lưu config. Cần khởi động lại app để apply mode mới.',
  },
  ...
  'mode.urls.title': {
    en: '🔗 Server URL for client machines',
    vi: '🔗 URL server cho máy nhân viên (Client)',
  },
  'mode.urls.hint': {
  ...
  'mode.urls.refresh_tt': {
    en: 'Refresh — re-read the current IP list',
    vi: 'Refresh — đọc lại danh sách IP hiện tại',
  },
