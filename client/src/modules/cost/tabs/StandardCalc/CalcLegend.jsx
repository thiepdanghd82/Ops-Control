...
eauCap = eau × 0.8      ← only 80% of lifetime EAU is amortizable`}
         ...
         ↑ tlife is a SHOT count / tlife là số SHOT, không phải pcs
goodPcs = tlife × layout × yield   ← shot → pcs is the × layout; yield = 1 − scrap
