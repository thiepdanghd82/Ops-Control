        ...
        <div className="sc-card">
          ...
          <div className="sc-card-body">
            <div className="sc-field">
              ...
              <select
                value={st.packing_method || 'Sheet'}
                onChange={(e) => handleField('packing_method', e.target.value)}
                className="sc-input"
              >
                {PACK_METHODS.map((m) => (
            ...
            <div className="sc-field">
              ...
              <input
                type="number"
                value={st.pcs_per_bag || ''}
                onChange={(e) => handleField('pcs_per_bag', e.target.value, true)}
                placeholder="—"
                className="sc-input"
              />
            </div>
            <div className="sc-field">
              ...
              <input
                type="number"
                value={st.bags_per_box || ''}
                onChange={(e) => handleField('bags_per_box', e.target.value, true)}
                placeholder="—"
                className="sc-input"
              />
            </div>
            <div className="sc-field">
              ...
              <DecimalInput
                value={st.container_cost}
                onChange={(v) => setStdField('container_cost', v)}
                placeholder="—"
                className="sc-input"
              />
            </div>
            <div className="sc-field">
              ...
              <DecimalInput
                value={st.box_cost}
                onChange={(v) => setStdField('box_cost', v)}
                placeholder="—"
                className="sc-input"
              />
            </div>
            <div className="sc-field">
              ...
              <DecimalInput
                value={st.other_packing}
                onChange={(v) => setStdField('other_packing', v)}
                placeholder="—"
                className="sc-input"
              />
            </div>
        ...
        <div className="sc-card">
          ...
          <div className="sc-card-body">
            <div className="sc-field">
              ...
              <input
                type="text"
                value={st.delivery_term || ''}
                onChange={(e) => handleField('delivery_term', e.target.value)}
                className="sc-input"
            ...
            <div className="sc-field">
              ...
              <input
                ...
                title={
                  st.ship_qty > 0 ? 'Override — clear to revert to MOQ' : 'Auto-synced from MOQ'
                }
              />
            </div>
            <div className="sc-field">
              ...
              <DecimalInput
                value={st.shipping_cost}
                onChange={(v) => setStdField('shipping_cost', v)}
                placeholder="—"
                className="sc-input"
              />
            </div>
            <div className="sc-field">
              ...
              <DecimalInput
                value={st.other_ship}
                onChange={(v) => setStdField('other_ship', v)}
                placeholder="—"
                className="sc-input"
              />
            </div>
