...
export default function Sidebar({
  ...
  const {
    ...
    inert,
    showHandle,
  } = resolveSidebarLayout({ autoHide, collapsed, revealed });
  ...
  return (
    <>
      {/* The way back out of auto-hide. A sibling of the <aside>, not a
          child — a child of a translated-off-canvas element is off-canvas
          too. Rendered only while hidden. */}
      {showHandle && (
        <button
          type="button"
          ...
          onClick={onReveal}
          aria-label={t('nav.sidebar.show')}
          title={t('nav.sidebar.show')}
        >
