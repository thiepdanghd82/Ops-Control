...
import { resolvePwdAgeLabel, resolvePwdAgeUnit } from './pwdAgeLabel';
    ...
    >
      {label !== false && (
        <div className="pwd-age-label">
          <span>{resolvePwdAgeLabel({ daysRemaining, label, t })}</span>
          <span className="pwd-age-days">
            {daysRemaining} / {maxAgeDays} {resolvePwdAgeUnit({ daysRemaining, t })}
          </span>
        </div>
      )}
